...
const SideNav = ({
  onToggleProfileDrawerHandler,
  onToggleContactDrawerHandler,
}) => {
  return (
    <div className='side-nav'>
      <SideNavHeader
        imageUrl='/IMG_2654.jpg'
        onProfileClick={onToggleProfileDrawerHandler}
        onContactClick={onToggleContactDrawerHandler}
      />
      <SideNavSearch placeholder='Search a chat' />
